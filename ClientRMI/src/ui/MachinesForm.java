...
public class MachinesForm extends javax.swing.JInternalFrame {
    ...
    public MachinesForm() {
        try {
            ...
            modelMachine = (DefaultTableModel) tbl_machines.getModel();
    ...
    public void loadGrid(){
      ...
      public void fillForm(){
         try {
            ...
            Machine m = daoMachine.findById(selectedMachineId);
            ...
            for (int i = 1; i < combo_salles.getItemCount(); i++) {
                Salle targetSalle = (Salle) combo_salles.getItemAt(i);
                if (m.getSalle().getId() == targetSalle.getId()) {
    ...
    public void clearAreas(){
        ...
        txt_marque.setText("");
        txt_prix.setText("");
        combo_salles.setSelectedItem(0);
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(combo_salles, 0, 181, Short.MAX_VALUE)
        ...
        getAccessibleContext().setAccessibleName("Gestion des Machine");
    ...
    private void btn_ajouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ajouterActionPerformed
        try {
            ...
            double prix = txt_prix.getText().isEmpty() ? 0:Double.parseDouble(txt_prix.getText());
            
            Salle salle=(Salle) combo_salles.getSelectedItem();
            
            if("".equals(ref) || marque.isEmpty() || salle == null){
    ...
    private void btn_supprimerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_supprimerActionPerformed
        try {
            daoMachine.delete(daoMachine.findById(selectedMachineId));
            JOptionPane.showMessageDialog(this,
                    "Machine supprimer avec succès", 
                    "Dialog",
                    JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btn_modifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modifierActionPerformed
        ...
        try {
            machine = null;
            machine = daoMachine.findById(selectedMachineId);
            
            machine.setMarque(txt_marque.getText());
            machine.setPrix(Double.parseDouble(txt_prix.getText()));
            machine.setRef(txt_ref.getText());
            salle = null;
            salle = (Salle) combo_salles.getSelectedItem();
             if("".equals(machine.getRef()) || machine.getMarque().isEmpty() || salle == null){
                JOptionPane.showMessageDialog(this,
    ...
    private void tbl_machinesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_machinesMouseClicked
        ...
        selectedMachineId = Integer.parseInt( tbl_machines.getModel().getValueAt(row, column).toString());
